...
_menu _mdi_menu {
   ...
   submenu "&Macro","help macro menu","Displays menu of macro programming commands","ncw" {
      ...
      "List User-Loaded Modules...","gui-list-macfiles","ncw","help macro menu","List user-loaded Slick-CÂ® modules";
      "-","","","","";
      "&Record Macro","record-macro-toggle","nicon","help macro menu","Starts recording Slick-CÂ® language macro based on the editor features you use";
      ...
      "Start Slick-CÂ® Debugger...","slickc-debug-start","ncw","help Debug","Activates the Slick-CÂ® debugger window";
      ...
      "-","","","","";
      "&Go to Slick-CÂ® Definition...","gui-find-proc\tfind-proc","ncw","help Macro Menu","Opens a macro source file and places your cursor on the definition of a macro symbol";
      ...
      "Load and Run &Form\tShift+Space","run-selected","ncw","help macro menu","Loads form, loads Slick-CÂ® code, and runs the currently selected/edited form.";
